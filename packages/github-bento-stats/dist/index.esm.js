...
var images = {
    assets: {
        bg3: new URL("./images/assets/bg3.png", import.meta.url).href,
        bg4: new URL("./images/assets/bg4.png", import.meta.url).href,
        black: new URL("./images/assets/black.png", import.meta.url).href,
        frame2: new URL("./images/assets/frame2.png", import.meta.url).href,
        frame2Svg: new URL("./images/assets/frame2.svg", import.meta.url).href,
        frame7: new URL("./images/assets/frame7.png", import.meta.url).href,
        frame7Svg: new URL("./images/assets/frame7.svg", import.meta.url).href,
        frame9Svg: new URL("./images/assets/frame9.svg", import.meta.url).href,
        grad1: new URL("./images/assets/grad1.svg", import.meta.url).href,
        grad11: new URL("./images/assets/grad11.svg", import.meta.url).href,
        grad2: new URL("./images/assets/grad2.svg", import.meta.url).href,
        grad4: new URL("./images/assets/grad4.svg", import.meta.url).href,
        grad5: new URL("./images/assets/grad5.svg", import.meta.url).href,
        grain: new URL("./images/assets/grain.svg", import.meta.url).href,
        user: new URL("./images/assets/user.svg", import.meta.url).href,
    },
    icons: {
        issues: new URL("./images/icons/issues.svg", import.meta.url).href,
        pr: new URL("./images/icons/pr.svg", import.meta.url).href,
    },
};
